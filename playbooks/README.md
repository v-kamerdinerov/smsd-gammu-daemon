   <p align="center">
     <img width="75%" src="../imgs/ansible.png" alt="IKNOWANSIBLE">
   </p>

Данная роль предназначена для автоматизации настройки и установки `gammu-smsd` на сервере, а также для интеграции с Telegram для отправки SMS-уведомлений. Роль выполняет следующие задачи:
...
3. **gammu_number**: Укажите номер телефона, который будет использоваться в уведомлении в TG (`опционально`).
