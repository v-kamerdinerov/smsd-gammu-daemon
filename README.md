...
<p align="center"><img src="https://avatars.mds.yandex.net/get-vthumb/2455229/ec6a9a38a6eef596fa8105ce9c74b794/800x450"></p>
...
Если вас не пугают слова - плейбук, ansible, инвентори - вы по адресу. После клонирования репозитория можно прогнать плейбук и получить вышеописанную инсталяцию, но уже посредством автоматики.
...
При этом рестарт сервиса systemd нам не поможет — могла произойти потеря связи с самим модемом, и потребуется физически переподключить модем, что чаще всего невозможно. 

Но мы не отчаиваемся - ведь у нас HAA-система, SLA 99.9999%!
