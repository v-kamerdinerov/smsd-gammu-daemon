...
Порой это связано с потерей интернет соединения, порой с волшебными процессами внутри модема - отвалы наблюдаются как сообщения в лога systemd - gammu-smsd:
